...
def run_multiclass_cam():
    ...
    model_path = os.path.join(project_root, 'results', 'trained_nets', 'fusion_best.pth')
    ...
    for idx, sample_idx in enumerate(selected_indices):
        img_tensor, sig_tensor, label, *_ = test_dataset[sample_idx]
